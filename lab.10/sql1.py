...
conn = psycopg2.connect(host="localhost", dbname="postgres", user="postgres", password="Alisatbai99", port=5432)
        ...
        if command == "i" or command == "I":
            ...
            if temp == "csv":
                ...
                # Skip the header row.
                    ...
                    next(reader)
                    for row in reader:
                        cur.execute("INSERT INTO phonebook (name, surname, phone) VALUES (%s, %s, %s)", (row[0], row[0], row[0],))
                conn.commit()
